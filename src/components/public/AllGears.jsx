...
//   const products = [
//     { id: 1, name: "6 X 4 Camping Tent", price: 500, image: "/images/tent.png", category: "Camping", features: ["Waterproof material", "Spacious for 4 people", "Easy setup with color-coded poles"] },
//     { id: 2, name: "Eco Friendly Stove", price: 350, image: "/images/stove.png", category: "Outdoor", features: ["Compact and lightweight", "Eco-friendly fuel system", "Stainless steel body"] },
//     { id: 3, name: "Trekking Backpack", price: 300, image: "/images/backpack.png", category: "Trekking", features: ["Adjustable straps", "Multiple compartments", "Breathable back panel"] },
//     { id: 4, name: "Portable Silverware", price: 250, image: "/images/silverware.png", category: "Outdoor", features: ["Compact and durable", "Made from stainless steel", "Easy to clean"] },
//     { id: 5, name: "Portable Gas Stove", price: 300, image: "/images/gasstove.png", category: "Camping", features: ["Portable and lightweight", "Perfect for camping and hiking", "Built-in ignition system"] },
//     { id: 6, name: "Trekking Bag", price: 300, image: "/images/trekbag.png", category: "Trekking", features: ["Durable fabric", "Water-resistant", "Designed for long treks"] },
//   ];
...
//         <h2 className="text-3xl font-extrabold mb-4 text-[#00693e] text-center">Choose the Gears You Need</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          {filteredProducts.map((product) => (
            <motion.div key={product.id} className="bg-white p-4 rounded-lg shadow-lg flex flex-col items-center text-center" whileHover={{ scale: 1.05 }}>
              ...
              <motion.button className="bg-[#D3D3D3] text-[#00693e] py-3 px-5 rounded-lg font-semibold text-lg mt-4" onClick={() => addToCart(product)} whileHover={{ scale: 1.1 }}>
                Add to Cart
              </motion.button>
            </motion.div>
          ))}
